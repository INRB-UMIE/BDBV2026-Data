...
Last successful build: **23 September 2026, 13:19:28 (UTC)** — `build/` on `main` at commit [`c40efc1`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/c40efc14c1e0c549ce823f35425a6239d80fd109) (data snapshot [`c40efc1`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/c40efc1), see `build/manifest.json`).
