...
Last successful build: **2 August 2026, 12:39:34 (UTC)** — `build/` on `main` at commit [`e9ab918`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/e9ab918b1514cced291fd762f780fb97c92a8ed7) (data snapshot [`e9ab918`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/e9ab918), see `build/manifest.json`).
