...
Last successful build: **21 July 2026, 22:40:52 (UTC)** — `build/` on `main` at commit [`8e2e7e4`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/8e2e7e4aad7384a6aa2a91101de17ace6401313e) (data snapshot [`8e2e7e4`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/8e2e7e4), see `build/manifest.json`).
