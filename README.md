...
Last successful build: **12 September 2026, 13:52:11 (UTC)** — `build/` on `main` at commit [`774e13d`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/774e13d87c344cabae6c8de76032668ee9254db3) (data snapshot [`774e13d`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/774e13d), see `build/manifest.json`).
