...
Last successful build: **14 June 2026, 20:31:32 (UTC)** — `build/` on `main` at commit [`69477ea`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/69477eaa16c503258bfd2280083d3665b6f5d27c) (data snapshot [`69477ea`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/69477ea), see `build/manifest.json`).
...
<!-- whats-new:start -->
updating data from sitRep 30 in insp_sitrep folder
<!-- whats-new:end -->
