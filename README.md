...
Last successful build: **25 August 2026, 12:38:50 (UTC)** — `build/` on `main` at commit [`4c7d570`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/4c7d570a14a638be6d5b6045adcae0b02d8d0d8a) (data snapshot [`4c7d570`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/4c7d570), see `build/manifest.json`).
